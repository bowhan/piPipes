...
contact piPipesQ@gmail.com for bugs and questions.
    ...
    while (getline(in2, line)) {
        ...
        if (found != hairpins.end()) {
            ...
            cerr << "Error : hairpin " << tempName
                 << " not found; Most likely you are using outdated version of miRBase to do mapping; could also because it is a miRNA can be assigned to more than one hairpins and you are using unique.bed"
                 << endl;
        }
    }
